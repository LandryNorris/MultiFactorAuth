...
@Serializable
data class User(@Transient override var id: String = "", var email: String, var firstName: String, var lastName: String, val passwordHash: String, val iv: String): IdAble {
